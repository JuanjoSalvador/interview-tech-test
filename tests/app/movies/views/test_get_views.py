...
def test_get_all_movies_view(api_client, mock_firestore_client, mock_firestore_movies):
    mock_db = MagicMock()
...
def test_get_one_movie_view(api_client, mock_firestore_client, mock_firestore_movies):
    mock_db = MagicMock()
    mock_firestore_client.return_value = mock_db
